...
class CuisineDishesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final dishesAsync = ref.watch(cuisineDishesProvider(cuisineName));
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () =>
                ref.invalidate(cuisineDishesProvider(cuisineName)),
          ),
        ],
      ),
      body: dishesAsync.when(
        ...
        loading: () => const LoadingWidget(message: 'AI is fetching dishes...'),
        error: (e, _) => Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
